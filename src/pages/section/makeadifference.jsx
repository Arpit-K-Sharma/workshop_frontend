  ...
  return (
    <section className="bg-gray-100 py-16 px-4 sm:px-6 lg:px-8 font-sans h-[600px] mt-11 flex items-center justify-center">
      <div className="text-center">
        ...
        <Button className="bg-blue-600 font-light text-white text-lg py-8 max-sm:py-6 max-sm:text-base max-sm:px-10 px-14 rounded-xl hover:bg-blue-700 transition duration-300">
          Get Started
        </Button>
      </div>
    </section>
