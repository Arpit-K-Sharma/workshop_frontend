    ...
    <aside className="w-56 h-screen bg-emerald-700 text-white shadow-lg font-archivo">
      <div className="p-4 flex items-center justify-center flex-col mt-10">
        ...
        <nav className="flex-grow overflow-y-auto w-full">
          <Button
            variant="ghost"
            className="w-full justify-start mb-2 text-sm hover:bg-emerald-900 hover:text-white transition-all duration-300 ease-in-out"
          ...
          <Button
            variant="ghost"
            className="w-full justify-start text-sm hover:bg-emerald-900 hover:text-white transition-all duration-300 ease-in-out"
