...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (studentsResponse.data.status === 'success' && schoolsResponse.data.status === 'success') {
        ...
        setPopularCourses([
          { "courseName": 'Python', "students": 250, color: 'rgba(59, 130, 246, 0.8)' },
          { "courseName": 'Java', "students": 150, color: 'rgba(16, 185, 129, 0.8)' },
          { "courseName": 'HTML', "students": 125, color: 'rgba(245, 158, 11, 0.8)' },
          { "courseName": 'React', "students": 100, color: 'rgba(99, 102, 241, 0.8)' },
          { "courseName": 'Node.js', "students": 75, color: 'rgba(20, 184, 166, 0.8)' },
        ]);
  ...
  const schoolCourseChartData = {
    ...
    datasets: ['Python', 'Java', 'HTML', 'React', 'Node'].map((course, index) => ({
      label: course,
        ...
        <main className="p-6 ml-56">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className='text-sm text-gray-600'>Total Partnered Schools</div>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card>
              ...
              <CardContent>
                <div className="h-80 ">
                  <Pie data={popularCoursesChartData} options={pieChartOptions} />
                </div>
              </CardContent>
            </Card>
          </div>
