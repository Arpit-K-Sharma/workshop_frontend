...
const CourseCard = ({ course }) => {
  ...
  return (
    <div
      className={`bg-white rounded-lg shadow-lg overflow-hidden transform transition duration-300 hover:scale-105 hover:shadow-xl min-w-[300px] ${
        showDescription ? "h-auto" : "h-[335px]"
      }`}
    >
      <img
      ...
      <div className="p-4">
        ...
        <h3
          ...
          className="text-lg font-semibold mb-2 text-gray-600 flex items-center"
        >
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          >
            ...
            Duration:{" "}
            <span className="text-gray-800 ml-1">{course.course_duration}</span>
          </span>
          <Button
